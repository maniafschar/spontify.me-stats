...
class ui2 {
	...
	static init() {
		communication2.language(window.window.global.language, function (response) {
		...
		if (location.search == '?intro')
			intro.openHint({ desc: 'Hier sind statistische Auswertungen.', pos: '15%,15em', size: '70%,auto', hinkyClass: 'top', hinky: 'left:50%;margin-left:-0.5em;' });
	}
}